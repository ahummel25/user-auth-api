...
type MutationResolver interface {
	...
	DeleteUser(ctx context.Context, user model.DeleteUserInput) (bool, error)
}
...
var sources = []*ast.Source{
	{Name: "../schema/auth.graphql", Input: `"The input needed to authenticate a user."
input AuthParams {
  "The user's username"
  username: String!
  "The user's password"
...
func (ec *executionContext) _Mutation_deleteUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().DeleteUser(rctx, fc.Args["user"].(model.DeleteUserInput))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			role, err := ec.unmarshalNRole2githubᚗcomᚋsrcᚋuserᚑauthᚑapiᚋgraphqlᚋmodelᚐRole(ctx, "ADMIN")
			if err != nil {
...
func (ec *executionContext) unmarshalInputDeleteUserInput(ctx context.Context, obj interface{}) (model.DeleteUserInput, error) {
	...
	fieldsInOrder := [...]string{"userID", "email", "firstName", "lastName", "userName"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
