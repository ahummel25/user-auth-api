...
import (
	...
	"github.com/src/user-auth-api/service/user/mocks"
)
...
func setup() (*mocks.API, resolvers.Services) {
	mockUserService := new(mocks.API)
	...
	return mockUserService, mockResolvers
}

func Test_AuthenticateUser_Success(t *testing.T) {
	mockUserService, mockResolvers := setup()
...
func Test_CreateUser_Success(t *testing.T) {
	...
	mockUserService.AssertCalled(t, "CreateUser", ctxArgMatcher, createUserInput)
