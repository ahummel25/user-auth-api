...
func (_m *API) CreateUser(ctx context.Context, params model.CreateUserInput) (*model.UserObject, error) {
	ret := _m.Called(ctx, params)

	var r0 *model.UserObject
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.CreateUserInput) (*model.UserObject, error)); ok {
		return rf(ctx, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.CreateUserInput) *model.UserObject); ok {
		r0 = rf(ctx, params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.UserObject)
...
// DeleteUser provides a mock function with given fields: ctx, params
func (_m *API) DeleteUser(ctx context.Context, params model.DeleteUserInput) (bool, error) {
	ret := _m.Called(ctx, params)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.DeleteUserInput) (bool, error)); ok {
		return rf(ctx, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.DeleteUserInput) bool); ok {
		r0 = rf(ctx, params)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, model.DeleteUserInput) error); ok {
		r1 = rf(ctx, params)
	} else {
		r1 = ret.Error(1)
	}
