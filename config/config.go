...
type SecretCache interface {
	...
	GetSecretStringWithStage(secretID string, stage string) (string, error)
	GetSecretBinary(secretID string) ([]byte, error)
	GetSecretBinaryWithStage(secretID string, stage string) ([]byte, error)
}
